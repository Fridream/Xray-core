...
type SocketConfig struct {
	...
	TCPConnectDelay        int32                  `json:"tcpConnectDelay"`
	TCPConnectCount        int32                  `json:"tcpConnectCount"`
	TCPConnectTimeout      int32                  `json:"tcpConnectTimeout"`
	TCPConnectTotalTimeout int32                  `json:"tcpConnectTotalTimeout"`
...
func (c *SocketConfig) Build() (*internet.SocketConfig, error) {
	...
	return &internet.SocketConfig{
		...
		TcpConnectDelay:        c.TCPConnectDelay,
		TcpConnectCount:        c.TCPConnectCount,
		TcpConnectTimeout:      c.TCPConnectTimeout,
		TcpConnectTotalTimeout: c.TCPConnectTotalTimeout,
